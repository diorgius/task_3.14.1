...
_Хранение данных как набора изменений относительно первоначальной версии каждого из файлов:_![](/pict/deltas.png "Хранение данных как набора изменений относительно первоначальной версии каждого из файлов")
...
_Хранение данных как снимков проекта во времени:_![](/pict/snapshots.png "Хранение данных как снимков проекта во времени")
...
_Git обычно только добавляет данные_
...
_Рабочая копия, область индексирования и каталог Git:_![](/pict/areas.png "Рабочая копия, область индексирования и каталог Git")
...
_Базовый подход в работе с Git выглядит так:_
